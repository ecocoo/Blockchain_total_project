...
### Начальный экран пользователя

![alt text](image.png)

### Выбираем год и нажимаем кнопку Vote for ...

![alt text](image-1.png)

### После голосования кнопки блокируются и пользователю остается дождаться окончания голосования для ознакомления с результатами

![alt text](image-2.png)

### Экран после окончания голосования
